...
let shapeSizeFactor = 5; // Default 5
let nodeCount = 3;       // Default 3
let curveAmount = 0;     // Fixed 0
let symmetryMode = "rotation_reflection6"; // Fixed Full Symmetry
let lineColor = "#000000"; // Fixed Black
let showNodes = true;
