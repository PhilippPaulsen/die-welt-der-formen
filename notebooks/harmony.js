function _1(md){return(
  ...
  *And only law can give us freedom.*  
  ...
  The concept of direction is immediately intuitive for
      ...
      specific direction.  
      A curved line or *curve* is characterized by having many
  ...
  A line with uniform curvature throughout is the
      ...
      but by ¹⁄*r*.  
      Any arbitrary curve that is not a circle has a different curvature
  ...
  As segments in cases 3 to 6, both curves and straight lines can occur. Particularly after case 5, lines frequently consist solely of interconnected straight segments.  
  Among the three types of discontinuities, the *shock* (No. 4) is
      not yet consciously utilized. On average, the eye is not yet trained
      to immediately recognize existing shocks. A lawful application of
      shocks is not yet perceived as a playful engagement with variety
      and, therefore, has no aesthetic value.  
  ...
  Until now, apart from continuity, we have made no
      ...
      The mathematical investigation of the sine wave confirms the eye\\'s
  ...
  Comparing the limited lawfulness of an
      ...
      process.
      *Fig. 20*  
      Additionally, the same free form *a b*, Fig. 21, can be rotated
      ...
      *bilateral*.
      *Fig. 21*  
      Any existing directional nature is not disturbed by this process.  
  ...
  By reflection, we generally mean a
      ...
      Fig. 22.  
      If the given form lies in a plane and its mirror image is also to
  ...
  A rotation occurs when a given form *a
      ...
      Fig. 23.  
      Thus, a rotation is characterized by the position of the axis and
  ...
  Repeating the rotation by the same angle
      ...
      *Fig. 24*  
      A structure formed by *n* shapes repeated through equal rotations is
  ...
  The ubiquitous motion of water, which has given its
      ...
      art.  
      Fig. 25.Fig. 26.  
      Particularly at the shore, one repeatedly observes how an
  ...
  Many technical methods recommend the use of
      ...
      *Fig. 28*  
      The arbitrariness regarding the angles at which these segments meet
  ...
  So far, wave lines have been chosen such that
      ...
      *Fig. 33*  
      This creates a very large range of possibilities, whose mathematical
  ...
  When a line terminates organically, that is, in a
      ...
      *taper off*.  
      *Fig. 34*  
      This is best achieved by making the waves progressively flatter
  ...
  If the rule requiring equal spacing between
      ...
      simplest.  
      *Fig. 35.*  
  The simplest rule is that the spacing increases or decreases in
  ...
  Since this entire work deals with sensations, it
      ...
      geometric sequence).  
      *Fig. 36.*  
      In a group of lines with equal spacing, the sensation of the spacing
  ...
  A new class of variations arises when the
      ...
      Fig. 37.  
      Another possibility is to avoid making the lines strictly parallel
