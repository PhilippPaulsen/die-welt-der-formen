function _1(md){return(
  ...
  ## Dieses Forschungsprojekt möchte dazu beitragen, Wilhelm Ostwalds Formenlehre einer breiteren Öffentlichkeit zugänglich zu machen: Im Herbst 2025 erscheint eine kritische Neuauflage im Verlag Spector Books Leipzig, die auch bisher unveröffentlichte Manuskripte und Fragmente einschließt, sowie Ostwalds Arbeiten im Spannungsfeld von Wissenschaft und Kunst, Gesetzmäßigkeit und Intuition, Ornament und Figur einordnet. Begleitend dazu lädt diese digitale Plattform (aktuell im Beta-Status) dazu ein, Ostwalds Texte, Formen und Gesetze mithilfe von interaktiven Grafiken zu entdecken.`
  )}
